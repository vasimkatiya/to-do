...
//     formCon.innerHTML = ` <form action="" class="edit-form">
//         <table>
//             <tr>
...
//                     priority : <input type="radio" name="priority" class="np" value="Low">Low
//                                <input type="radio" name="priority" id="" class="np" value="Medium">Medium
//                                <input type="radio" name="priority" id="" class="np" value="High">High     
//                 </td>
//                 <td><select name="" id="" class="new-project-name">
...
//     const form = formCon.querySelector(".edit-form");

    
//     form.querySelector(".ntask").value = task.task;
//     form.querySelector(".ndescription").value = task.descripton;
//     form.querySelector(".ndate").value = task.date;
//     form.querySelector(".nnotes").value = task.notes;
//     form.querySelector(".np:checked")?.value = task.priority;
//     form.querySelector("select").value = task.projectname;
...
//         task.descripton = form.querySelector(".ndescriptiion").value.trim();
...
//         task.projectname = form.querySelector("select").value;
